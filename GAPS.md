...
| GAP-M9-03 | P2 | Не-MCP HTTP/gRPC control-API + OSS чат-UI в DH (плюс MCP-путь через M7) | M9.3: control-API (`cmd/control-api`, ADR-032) + setup-WebUI live-mode **DONE** (Волна B p1/p2); OSS чат-UI + CI-шаблоны — остаются |
