...
| **4** | Сломался САМ ИНСТРУМЕНТ (ADR-087) | Наше исключение, вакуумный обход или ненаписанный собственный артефакт — вина `tool`, НЕ находка о приложении |
| **5** | Инструмент сломался, найденное сохранено (ADR-131) | Обход до места обрыва записан в артефакт: план, карта, сценарий |
