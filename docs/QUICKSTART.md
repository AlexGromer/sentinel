...
| 4 | сломался САМ ИНСТРУМЕНТ — НЕ находка о вашем приложении (ADR-087) |
| 5 | инструмент сломался, но найденное сохранено (ADR-131) |
| -1 | не запустился либо убит сигналом ⚠ синтетический код, процессом не возвращается |
