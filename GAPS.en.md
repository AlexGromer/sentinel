...
| GAP-M9-03 | P2 | Non-MCP HTTP/gRPC control API + OSS chat-UI in DH (plus the MCP path via M7) | M9.3: control-API (`cmd/control-api`, ADR-032) + setup-WebUI live-mode **DONE** (Wave B p1/p2); OSS chat-UI + CI templates — remaining |
